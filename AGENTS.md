...
- `<Table>`: Tabular layout with `<Table.Row>` and `<Table.Cell>` for structured rows and columns.
...
type CardProps = {
  ...
  /** Border applied to the card; accepts a numeric pixel value or a border object. */
...
type TableProps = {
  /** Rows to render within the table. */
  children?: React.ReactNode
}

type TableRow = React.FC<TableRowProps>
type TableRowProps = {
  /** Cells to render within the row. */
  children?: React.ReactNode
  /** Render this row using table header cells. */
  header?: boolean
}
...
type TableCellProps = {
  ...
  children?: React.ReactNode
  /** Explicit width for the cell; accepts a numeric pixel value or a CSS string. */
  width?: number | string
  /** Inner spacing for cell content; accepts a spacing unit, CSS string, or padding object. */
  padding?: number | string | Padding
  ...
  /** Size hint used when distributing column widths. */
